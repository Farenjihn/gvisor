...
// IterDirents implements Inode.IterDirents.
// TODO(gvisor.dev/issue/1193): Actually implement IterDirents. Shift logic
// GenericDirectoryFD to here. Will need to get rid of vfs.Filesystem
// parameter in Inode.Stat.
...
// AlwaysValid partially implements inodeLookup.
//
// +stateify savable
type AlwaysValid struct{}

// Valid implements inodeLookup.Valid.
func (*AlwaysValid) Valid(context.Context) bool {
	return true
}

// InodeTemporary partially implements inodeLookup.
//
// +stateify savable
type InodeTemporary struct{}

// Keep implements inodeLookup.Keep.
